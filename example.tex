...
\begin{document}
	...
	\cvdatedentry{International Conference on Computational Mechanics 2023}{Jul. 2023}{%
			Adaptive Refinement Strategies for Elastoplastic Finite Element Analysis, \textit{A. Johnson, B. Schmidt, C. Mueller}
	}

	\cvsection{\faRocket}{Projects}
	\cventry{Finite Element Solver Library}{%
